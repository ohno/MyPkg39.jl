...
This page describes how to contribute to [MyPkg39.jl](https://github.com/ohno/MyPkg39.jl).

## Contributing

Please open an [issue](https://github.com/ohno/MyPkg39.jl/issues) before starting significant work. The [ColPrac](https://github.com/SciML/ColPrac) guidelines is recommended. 
...
- [Project.toml](https://github.com/ohno/MyPkg39.jl/blob/main/Project.toml#L4)
- [CITATION.bib](https://github.com/ohno/MyPkg39.jl/blob/main/CITATION.bib#5)
...
```sh
git clone https://github.com/ohno/MyPkg39.jl.git
cd MyPkg39.jl
```
...
```sh
julia --startup-file=no -i -E 'using Revise; import Pkg; Pkg.activate(\".\"); using MyPkg39; MyPkg39.hello()'
```

### Add Dependency

Use these commands to add `PkgName.jl` as a dependency. `Pkg.add` updates [Project.toml](https://github.com/ohno/MyPkg39.jl/blob/main/Project.toml). If dependencies were edited manually, run `Pkg.resolve()` and `Pkg.instantiate()`.
